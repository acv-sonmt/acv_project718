...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li><a href="admin/customer/add">Forms</a></li>
...
<div class="col-md-6">
	<div class="box box-primary">
		...
		@endif
		<form role="form" method="POST" action="admin/customer/add">
			...
			<div class="box-body">
				...
				<div class="form-group">
					...
					<input type="age" class="form-control" id="age" placeholder="Day of birth" name="age">
				</div>
