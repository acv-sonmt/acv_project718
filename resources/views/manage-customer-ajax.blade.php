...
<body>
			...
			<div class="col-lg-12 margin-tb">					
				...
				<div class="col-sm-5 form-group">
					<div class="input-group">
						<input class="key form-control" id="search"
						value=""
		...
		<div class="modal-dialog" role="document">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form data-toggle="validator" action="{{ route('customer-ajax.store') }}" method="POST">
	...
	<div class="modal fade" id="edit-customer" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
...
<script type="text/javascript">
	...
	var url = "<?php echo route('paginate')?>";
